            ...
            <tree-item v-for="(child, index) in data"
                ...
                <template slot-scope="_">
                    <slot :vm="_.vm" :model="_.model">
                        ...
                        <span v-if="_.model[taskRunId] !== 'None'" style="padding:0px 0px 0px 5px">
                            <b-link target="_blank" title="open workflow for this task" :href="'/text-extract-airflow/admin/airflow/graph?dag_id=text-extract-pipeline&run_id='+_.model[taskRunId]"><i class="fas fa-project-diagram"></i></b-link>                             
                        </span>
                        <!-- <h1>{{$log(_)}}</h1> -->                        
                    </slot>                    
                </template>
...
<script>
    ...
    export default {
        ...
        props: {
            ...
            taskRunId: {type: String, default: 'task_run_id'},
