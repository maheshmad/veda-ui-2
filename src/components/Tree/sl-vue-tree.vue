<template>
  <div
    ...
    <div ref="nodes" class="sl-vue-tree-nodes-list">
      <div class="sl-vue-tree-node" v-for="(node, nodeInd) in nodes" :key="node.id" :class="{'sl-vue-tree-selected': node.isSelected }">
        <div
        ...
        >
          <div class="sl-vue-tree-gap" v-for="gapInd in gaps" :key="gapInd.id"></div>
